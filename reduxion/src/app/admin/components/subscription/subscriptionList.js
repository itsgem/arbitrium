        ...
        <div className="mdl-grid filter-search-bar">
          ...
          <div className="mdl-cell mdl-cell--3-col">
            <div className="mdl-textfield mdl-block mdl-js-textfield mdl-textfield--floating-label">
              ...
              <label className="mdl-textfield__label">{tr.t('LABEL.SUBSCRIPTION')}</label>
            </div>
          </div>
          <div className="mdl-cell mdl-cell--3-col">
            <div className="mdl-textfield mdl-block mdl-js-textfield mdl-textfield--floating-label">
              <input className="mdl-textfield__input" type="text" id="type" ref="type" />
              <label className="mdl-textfield__label">{tr.t('LABEL.PLAN_TYPE')}</label>
            </div>
          </div>
        ...
        <table className="mdl-data-table mdl-js-data-table table-client-list">
          <thead>
            <tr>
              ...
              <th className="mdl-data-table__cell--non-numeric">{tr.t('LABEL.COMPANY_NAME')}</th>
              <th className="mdl-data-table__cell--non-numeric">{tr.t('LABEL.REPRESENTATIVE_NAME')}</th>
              <th className="mdl-data-table__cell--non-numeric">{tr.t('LABEL.EMAIL_ADDRESS')}</th>
              <th className="mdl-data-table__cell--non-numeric">{tr.t('LABEL.SUBSCRIPTION')}</th>
              <th className="mdl-data-table__cell--non-numeric">{tr.t('LABEL.PLAN_TYPE')}</th>
              <th className="mdl-data-table__cell--non-numeric">{tr.t('LABEL.STATUS')}</th>
