          ...
          <div className="content-container">
            <div className="mdl-grid content">
              ...
              <div className="mdl-cell mdl-cell--4-col">
                ...
                <p>{tr.t('LABEL.SUBSCRIPTION_PERIOD')}: <span className="invoice-value">{adminInvoiceDetail.subscription_details ? moment(adminInvoiceDetail.subscription_details.valid_from).format('YYYY-MM-DD') : ''} to {adminInvoiceDetail.subscription_details ? moment(adminInvoiceDetail.subscription_details.valid_to).format('YYYY-MM-DD') : ''}</span></p>
              </div>
              <div className="mdl-cell mdl-cell--4-col">
