        ...
        <div className="date-range">
          <div className="mdl-grid filter-search-bar">
            ...
            <div className="mdl-cell mdl-cell--6-col text-right">
              <button onClick={(e) => this.searchList(e) } className="margin-right-10 mdl-button mdl-js-ripple-effect mdl-js-button mdl-button--raised mdl-button--accent"><i className="material-icons">search</i>Search</button>
